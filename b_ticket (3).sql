...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2022 at 04:50 AM
...
('wdwdw', 'dw', 'wd', 0, 0, 'wdw', 2, '', 'ddwd', 'qdqdq'),
('Jimma vs arbaminch', 'AddisAbaba', '2014:11:05', 100, 1000, 'Postponed', 12, 'bunna.png', 'club.jpg', 'Hold on and get you tickets for free. Thats right a free pass is being given away fort free.The division is ever becoming tighter'),
('', '', ' ', 0, 0, 'dwd', 135, 'dwd', '', ''),
('dwd', 'dwd', 'dwdw ', 0, 0, '', 136, '', '', '');
...
('admin', '698406205', 982096381, 'ADMIN'),
('firaol', '963512601', 1965851634, 'USER');
...
--
ALTER TABLE `concert`
  MODIFY `Concert_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5457;

--
-- AUTO_INCREMENT for table `football`
--
ALTER TABLE `football`
  MODIFY `F_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
